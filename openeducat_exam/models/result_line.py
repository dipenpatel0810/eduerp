...
class OpResultLine(models.Model):
    ...
    program_id = fields.Many2one('op.program', 'Program', readonly=True)
    subject_id = fields.Many2one('op.subject', 'Subject' )
    session_id = fields.Many2one(related = 'exam_id.session_id', string="Exam Session")
    ...
    def onchange_exam(self):
        ...
        self.subject_id = self.exam_id.subject_id
