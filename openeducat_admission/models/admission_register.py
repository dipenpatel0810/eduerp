...
class batch_register(models.Model):
    _inherit = 'op.batch'
    batch_register = fields.One2many('op.admission.register','batch_id',string="Linked Admission Register::")
...
class OpAdmissionRegister(models.Model):
    ...
    department_ids = fields.Many2one('op.department', string='Department', size=128, required=True)
